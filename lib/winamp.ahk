...
;-------------------------------------------------------------------------------
    ...
    ;[  Minimize  ]
    ;[============]
    if p_Command in minimize,winminimize
        {
        IfWinExist ahk_group l_WinampGroup
            {
            l_ReturnCode:=true
    ...
    ;[  Maximize  ]
    ;[============]
    if p_Command in maximize,winmaximize
        {
        IfWinExist ahk_group l_WinampGroup
            {
            l_ReturnCode:=true
            IfWinNotActive ahk_group l_WinampGroup
                WinMaximize %l_WinampWindowTitle%
            }
         else
            l_ReturnCode:=false
        return
    ...
    ;[  Restore  ]
    ;[============]
    if p_Command in restore,winrestore
        {
        IfWinExist ahk_group l_WinampGroup
            {
            l_ReturnCode:=true
            IfWinNotActive ahk_group l_WinampGroup
                WinRestore %l_WinampWindowTitle%
            }
         else
            l_ReturnCode:=false
        return
	...
	WA_WM_COMMAND_ToggleMain   =40258   ;-- Toggle main window
	WA_WM_COMMAND_ToggleShuffle=40023   ;-- Toggle shuffle
    ...
    ;
    ;---------------------------------------------------------------------------
	WA_WM_COMMAND_StopAfter		=40157	;-- Stop after current track 
	WA_WM_COMMAND_JumpTo		=40194	;-- Jump to file dialog box
	WA_WM_COMMAND_TogglePlaylist=40040	;-- Toggle playlist window
